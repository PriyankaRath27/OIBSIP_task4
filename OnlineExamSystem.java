...
public class OnlineExamSystem {
    ...
    private static Question[] loadQuestions() {
        ...
        questions[0] = new Question("In C, what are the various types of real data type (floating point data type)?", new String[]{"A. float long double", "B. long double, short int", "C. float, double, long double" , "D.  short int, double, long int, float"}, 2);
        questions[1] = new Question("number of keywords present in c language are .?", new String[]{"A. 32", "B. 34", "C. 62","D. 64"}, 0);
